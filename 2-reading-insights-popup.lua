...
local PATCH_L10N = {
    ...
    hu = {
        ...
        ["November"] = "November",
        ["December"] = "December",
        ["second read"] = "másodperc olvasva",
        ["seconds read"] = "másodperc olvasva",
        ["minute read"] = "perc olvasva",
        ["minutes read"] = "perc olvasva",
        ["hour read"] = "óra olvasva",
        ["hours read"] = "óra olvasva",
		["book"] = "könyv",
		["books"] = "könyv",
		["day"] = "nap",
		["days"] = "nap",
		["daily record"] = "napi rekord",
        ["day read"] = "napon olvasás",
        ["days read"] = "napon olvasás",
        ["page read"] = "oldal elolvasva",
        ["pages read"] = "oldal elolvasva",
		["week"] = "hét",
		["weeks"] = "hét",
		["weekly record"] = "heti rekord",
        ["week in a row"] = "hetek egyhuzamban",
        ["weeks in a row"] = "hetek egyhuzamban",
        ["day in a row"] = "napok egyhuzamban",
        ["days in a row"] = "napok egyhuzamban",
        ["page"] = "oldal",
        ["pages"] = "oldal",
        ["TODAY"] = "MA",
        ...
        ["Reading statistics: reading insights"] = "Olvasási statisztikák: olvasás elemzése",
        ["Unknown"] = "Ismeretlen",
        ["No books read"] = "Nincs olvasott könyv",
        ["No books read in %1"] = "Nincs olvasott könyv ekkor: %1",
        ["No books read in "] = "Nincs olvasott könyv ekkor: ",
        ["%1 - Book Read (%2)"] = "%1 - Könyv olvasva (%2)",
        ["%1 - Books Read (%2)"] = "%1 - Könyv olvasva (%2)",
    },
}
